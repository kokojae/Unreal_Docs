#undef UNREAL_DOCS_API
#undef UNREAL_DOCS_VTABLE
...
#define UE_PROJECT_NAME Unreal_Docs
...
#define UNREAL_DOCS_VTABLE DLLEXPORT_VTABLE
#define UNREAL_DOCS_API DLLEXPORT
