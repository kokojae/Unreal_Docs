#undef HOWTO_PLAYERCAMERA_API
#undef HOWTO_PLAYERCAMERA_VTABLE
...
#define UE_PROJECT_NAME HowTo_PlayerCamera
...
#define HOWTO_PLAYERCAMERA_VTABLE DLLEXPORT_VTABLE
#define HOWTO_PLAYERCAMERA_API DLLEXPORT
